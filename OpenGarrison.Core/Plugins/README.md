...
- Plugin implementation projects own their own output path into the runtime plugin folders under `OpenGarrison.Client/bin/.../Plugins/Client/<PluginName>/` or `OpenGarrison.Server/bin/.../Plugins/Server/<PluginName>/`.
