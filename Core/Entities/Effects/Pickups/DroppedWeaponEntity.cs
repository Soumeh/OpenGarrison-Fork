...
public sealed class DroppedWeaponEntity : SimulationEntity
{
    public const int LifetimeTicks = 720;
    public const int FadeTicks = 60;
    public const float Width = 18f;
    public const float Height = 10f;
    public const float PickupWidth = 24f;
    ...
    public PlayerClass WeaponClassId { get; }
